...
public class Example6Controller {
	...
	public String add(Flight flight, Map model) { //directly give name of bean if all value and property name in bean are same,
		//it will read the request parameter and pass the values directly
